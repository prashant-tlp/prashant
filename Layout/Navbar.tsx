...
const Navbar = () => {
  ...
  return (
    <nav className="justify-around  items-center  md:flex gap-2 w-full  ">
      ...
      <ul className={`text-left fixed w-full md:w-auto bg-orange-300 md:static md:bg-transparent z-30 flex-col  text-2xl md:text-xl ${navOpen?'hidden':'block'} md:flex  md:flex-row gap-10 text-pretty font-semibold`}>
